...
<html lang="id">
  ...
  <script>
        $(document).ready(function(){
          ...
          $('#btn-simpan').on('click',function(){
            ...
            $.ajax({
              ...
              url: "<?php echo base_url(); ?>index.php/entry/tambah_data",
              type: "POST",
        ...
        $('#lihatdata').on('click','.klik-edit', function(){
          ...
          $('#form-ubah').attr('action','<?php echo base_url(); ?>index.php/entry/perbarui_data');
          $.ajax({
            type : 'ajax',
            method : 'get',
            url : '<?php echo base_url(); ?>index.php/entry/ubah_data',
            data : {id: id},
            dataType : 'json',
            success : function(data)
            {
        ...
        // ubah data
          $('#btn-ubah').on('click',function(){
            ...
            $.ajax({
              ...
              url: "<?php echo base_url(); ?>index.php/entry/perbarui_data",
              type: "POST",
          ...
          //alert(id);
          $.ajax({
            url: "<?php echo base_url(); ?>index.php/entry/hapus_data",
            type: "POST",
            data: {id:id},
            dataType: 'json',
            async: false,
          ...
          function lihatEntry(){
            $.ajax({
              type : 'ajax',
              url : "<?php echo base_url(); ?>index.php/entry/lihat_data",
              dataType : 'json',
              success : function(data)
              {                
                var html = '';
